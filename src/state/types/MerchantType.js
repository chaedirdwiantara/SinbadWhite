...
export const MERCHANT_POST_ACTIVITY_PROCESS_V2 =
  'MerchantPostActivityProcessV2';
export const MERCHANT_POST_ACTIVITY_SUCCESS_V2 =
  'MerchantPostActivitySuccessV2';
...
export const MERCHANT_GET_SURVEY_LIST_LOADMORE =
  'MerchantGetSurveyListLoadMore';
/** MERCHANT GET TOTAL SURVEY*/
export const MERCHANT_GET_TOTAL_SURVEY_PROCESS =
  'MerchantGetTotalSurveyProcess';
export const MERCHANT_GET_TOTAL_SURVEY_SUCCESS =
  'MerchantGetTotalSurveySuccess';
...
export const MERCHANT_GET_SURVEY_BRAND_PROCESS =
  'MerchantGetSurveyBrandProcess';
export const MERCHANT_GET_SURVEY_BRAND_SUCCESS =
  'MerchantGetSurveyBrandSuccess';
...
/** MERCHANT CHECK RETUR ACTIVE */
export const GET_RETURN_ACTIVE_INFO_PROCESS = 'GetReturnActiveInfoProcess';
export const GET_RETURN_ACTIVE_INFO_SUCCESS = 'GetReturnActiveInfoSuccess';
export const GET_RETURN_ACTIVE_INFO_FAILED = 'GetReturnActiveInfoFailed';
