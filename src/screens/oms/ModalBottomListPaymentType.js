...
import { getPaymentMethod } from '../../redux/actions';
import SkeletonPlaceholder from 'react-native-skeleton-placeholder';

const { height } = Dimensions.get('window');

class ModalBottomListPaymentType extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    this.props.getPaymentMethod(this.props.parcelId);
  }
  ...
  renderListPaymentType() {
    return this.props.cart.dataPaymentMethod.map((item, index) => {
      return (
        <View key={index}>
          {!item.availableStatus ? (
        ...
        <View style={styles.container}>
          <View style={{ height: 60 }}>
            <View style={styles.closeContainer}>
              ...
              >
                <Image
                  source={require('../../assets/icons/Icon-ios-back-black.png')}
                  style={styles.icons}
                />
              </TouchableOpacity>
          ...
          <View style={styles.contentContainer}>
            {!this.props.cart.loadingGetPaymentMethod &&
            this.props.cart.dataPaymentMethod !== null ? (
...
export default connect(mapStateToProps, { getPaymentMethod })(
