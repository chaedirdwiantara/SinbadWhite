import { React, Component, View, Text, SafeAreaView, StyleSheet } from '../../library/reactPackage'
...
const styles = StyleSheet.create({
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(HistoryDetailPaymentInformation);